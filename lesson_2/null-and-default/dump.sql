...
--
-- Name: weather; Type: TABLE; Schema: public; Owner: gudsson
--
...
ALTER TABLE public.weather OWNER TO gudsson;

--
-- Data for Name: weather; Type: TABLE DATA; Schema: public; Owner: gudsson
--
